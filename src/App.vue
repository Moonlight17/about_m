<template>
  <div id="app" class="back" style="">
    ...
    <div id="resume" class="align-self-start position-relative" :style="{'min-height': `${calcEduc}px`}">
        <Resume :me="me"/>
    </div>
    ...
    <div id="selfedu" class="align-self-start position-relative" :style="{'min-height': `${calcEduc}px`}">
        <SelfEdu :data="me.courses"/>
    </div>
    <!-- <div id="ololo">
